          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-3xl p-12">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                MoodiQ was born from a simple observation: music affects how we feel, but we rarely analyze why. We built this platform to bridge the gap between your playlists and your emotions.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Whether you're looking to energize your workout, focus during study sessions, or wind down after a long day, MoodiQ ensures your music always hits the right emotional note.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-12 shadow-xl">
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
              MoodiQ combines Spotify's rich audio feature data with custom machine learning models trained on thousands of songs. We analyze:
            </p>
